...
export function LandingPage() {
  ...
  // We unlock native scrolling on body while on the landing page and clean up when leaving.
  useEffect(() => {
  ...
  return (
    <div id="landing-scroll-container" className="min-h-screen w-full overflow-x-hidden bg-[#000000] text-foreground font-sans selection:bg-white/20 selection:text-white scroll-smooth relative">
      ...
      {/* 5. PLATFORM INSIGHTS & MULTI-AGENT SWARM TIMELINE */}
      ...
      {/* 7. FLOATING COMMAND DOCK (ICONIC TURQUOISE ACCENT) */}
